...
class HomeHeader extends StatelessWidget {
  ...
  Widget _profileImage(BuildContext context,UserEntity user) {
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(image:user.image.isEmpty ?const AssetImage(Assets.imagesProfile1): NetworkImage(user.image)),
        color: Colors.red,
  ...
  Widget _gender(UserEntity user) {
    return Container(
      ...
      child: Center(child: Text(user.gender == 1 ? "Men" : "Women", style: AppStyle.styleBold12)),
    );
  }
